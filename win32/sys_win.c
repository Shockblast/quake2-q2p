	...
	if (!GetVersionEx(&info))
		...
		if (info.dwPlatformId == VER_PLATFORM_WIN32_WINDOWS) {
			...
			if (info.dwMajorVersion == 4 && info.dwMinorVersion == 0)
				Com_Printf("OS: Windows 95 build %d version %d\n",
				           info.dwBuildNumber, info.szCSDVersion);
			if (info.dwMajorVersion == 4 && info.dwMinorVersion == 10)
				Com_Printf("OS: Windows 98 build %d version %d\n ",
				           info.dwBuildNumber, info.szCSDVersion );
			if (info.dwMajorVersion == 4 && info.dwMinorVersion == 90)
				Com_Printf("OS: Windows Me build %d version %d\n",
				           info.dwBuildNumber, info.szCSDVersion);	
		}
		else if (info.dwPlatformId == VER_PLATFORM_WIN32_NT) {
			if ( info.dwMajorVersion <= 4)
				Com_Printf("OS: Windows NT build %d\n",
				           info.dwBuildNumber);
                	if ( info.dwMajorVersion == 5 && info.dwMinorVersion == 0)
				Com_Printf("OS: Windows 2000 build %d\n",
				           info.dwBuildNumber);
                	if ( info.dwMajorVersion == 5 && info.dwMinorVersion == 1)
				Com_Printf("OS: Windows XP build %d\n",
				           info.dwBuildNumber);
		}
	}
}
...
//	Com_Printf("Q2P -- Dedicated -- Version %0.1f\n", Q2PVERSION);
