...
unsigned long net_total_in;
unsigned long net_total_out;
unsigned long net_packets_in;
unsigned long net_packets_out;
#endif
...
void Net_Stats_f (void)
{
	...
	if( gethostname( buffer, sizeof( buffer ) ) == ERROR_SOCKET ) {
		Com_Printf( "Couldn't get machine hostname\n" );
		return;
	}
...
void NET_Init (void)
{
	...
	Cmd_AddCommand ("netstats", Net_Stats_f);
