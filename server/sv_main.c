...
#ifdef __unix__
cvar_t	*sv_oldgame_so;		/* Skuller hack */
#endif
...
#ifdef __unix__
	sv_oldgame_so	  = Cvar_Get ("sv_oldgame_so", "1", CVAR_LATCH);
#endif
...
qboolean IsVisible(vec3_t org1, vec3_t org2)
{
	...
	trace = SV_Trace (org1, NULL, NULL, org2, NULL, MASK_VISIBILILITY);
	/* trace = SV_Trace_2 (org1, org2, 0, MASK_VISIBILILITY); */
